...
const char* ssid = "TEJA"; 
const char* password = "1234UYFEDG";

String BOTtoken = "6374288023:AAGEVFVOhEhts2RQIyt_Co4daiTZ4RhadIo"; 
...
bool ldr_Sensor_is_stable = false;  
